...
if (isset($_GET['car_id'])) {
    $carId = $_GET['car_id']; // Get the car ID from the URL
} else {
    // Handle the case where car_id is not passed in the URL
        ...
        <div class="lading-page-content p-5">
            ...
            <a href="update-car-first.php">
              ...
              <div class="container my-2 p-0">
                <h3 class="text-center text-warning mb-4"><strong>Update Car Details</strong></h3>
                <form action="../owner_process/updatecar_validation.php" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="rounded bg-white p-2 pt-5 custom-shadow">
                        <div class="row g-5 d-flex justify-content-center"> 
                          ...
                          <div class="col-12 text-center mt-4 mb-3">
                            <button type="submit" class="btn btn-dark" style="color: #f0a500;">Update</button>
                          </div>
                        </div>
                      </div>
                    </form>
