...
<body>
      ...
      <div class="main-content">
        ...
        <div class="lading-page-content position-relative">
            ...
            <!-- Confirmation Dialog (Centered & Hidden by Default) -->
            <div id="confirmationDialog"
                 class="position-absolute top-50 start-50 translate-middle"
                 style="display: none; padding: 20px; box-shadow: 0 4px 8px rgba(0,0,0,0.2); border-radius: 10px; background-color: #fff; z-index: 1000; min-width: 250px;">
              <p class="mb-3 text-center fw-semibold">Are you sure you want to delete this car?</p>
            ...
            <div class="card" style="width: 200px; border: 1px solid #ddd; border-radius: 10px;">
              <div class="card-body p-3 pt-2">
                ...
                <!-- Delete Button -->
                <button class="btn btn-dark d-flex justify-content-center align-items-center gap-2 rounded-pill px-3 py-1"
                        style="font-size: 12px; width: 100%;" onclick="showConfirmationDialog(<?= $car['car_id']; ?>)">
                    <img src="./image/car-details.png" alt="Delete Icon" style="width: 12px; height: 12px;">
  ...
  <script>
    ...
    carIdToDelete = carId;  // Store the car ID when the user clicks delete
...
function confirmDelete() {
    if (confirm("Are you sure you want to delete this car?")) {
        ...
        xhr.open("POST", "../owner_process/delete_validation.php", true);
        xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");

        xhr.onload = function () {
            if (xhr.status === 200 && xhr.responseText.includes("successfully")) {
                alert("Car deleted successfully!");
                window.location.href = "../onwer-landing/car-listing.php"; // Redirect after successful deletion
            } else {
        ...
        // Send the carIdToDelete stored from the showConfirmationDialog
        xhr.send("car_id=" + encodeURIComponent(carIdToDelete));
    }
}
