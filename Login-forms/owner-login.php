                ...
                <div class="design">
                    ...
                    <!-- ../index.html -->
                        <form action="../validations/login_validate.php" method="POST">
                            ...
                            <h4 class="choose-login-h4">Login Owner Account</h4>
                            ...
                            <div class="input-wrapper">
                              ...
                              <a class="forgot-password-design" href="owner-forgot-password.php">Forgot Password?</a>
                            ...
                            <!-- <button class="google-login-button">
                                    <a href="../googleAuth/google-login.php?account_type=owner">
                                        <img src="../Simg/google-icon.png" alt=""> Login with Google
                                    </a>
                                </button> -->

                            <span>Don't have an account? <a href="owner-create-account.php">Create account</a></span>
                        </form>
                    </div>
                </div>
