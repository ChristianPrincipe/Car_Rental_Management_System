        ...
        <div class="main d-flex justify-content-center align-items-center">
            ...
            <div class="form-container d-flex flex-column">
                ...
                <div class="position-relative">
                    <button class="button-design back-button "><a href="choose-to-create.html"><img src="../button/back-button.png"></a></button>
                ...
                <div class="design">
                    ...
                    <div class="choose-main-form">
                        ...
                        ?>
                            ...
                            <h6 class="input-h6">Enter password</h6>
                            <input class="long-box-input" type="password" name="password" placeholder="Password" required>
                            <h6 class="input-h6">Re-enter password</h6>
