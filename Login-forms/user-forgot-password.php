            ...
            <div class="form-container d-flex flex-column">
                ...
                <div class="design">
                    ...
                    <div class="choose-main-form">
                        <form action = "../forgot_process/send_code.php" method="POST">
                    ...
                    ?>
                            ...
                            <input class="long-box-input" type="email" name="email" placeholder="Enter your email" required>
                            <button type= "submit" class="create-account" >Send Code</button>
                        </form>
                    </div>
                </div>
